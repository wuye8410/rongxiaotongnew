<template>
  ...
  <div class="mx-auto px-20">
    ...
    <div class="space-y-2">
          ...
          <div class="p-4">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex space-x-2">
                <button @click="proDataChange(product);showPublishDialog = true" class="text-blue-500 hover:text-blue-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
      ...
      <div v-if="goodsData.length === 0" class="px-3 py-10 text-center text-gray-500">        
      暂无数据        
      </div>
